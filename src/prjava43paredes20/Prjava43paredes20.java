package prjava43paredes20; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43paredes20 extends Frame 
   ...
   public Prjava43paredes20 () { 
      ...
      setTitle("nova finestra prjava43paredes20");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43paredes20();  // Let the construct do the job 
   } 
